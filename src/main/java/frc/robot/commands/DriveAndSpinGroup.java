...
public class DriveAndSpinGroup extends ParallelCommandGroup {
public final Chassis m_chassis = new Chassis(); // is this being static okay
   ...
   */
  public DriveAndSpinGroup(Chassis chassis, Intake takeInCells) {
    // Add your commands in the super() call, e.g.
    // super(new FooCommand(), new BarCommand());
    super(new MotionMagic(chassis, -180), new IntakeInward(takeInCells));
