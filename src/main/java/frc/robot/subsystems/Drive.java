...
public class Drive extends SubsystemBase {
  ...
  private final SpeedControllerGroup m_leftMotors =
      new SpeedControllerGroup(new PWMVictorSPX(Constants.LeftLeader),
                               new PWMVictorSPX(Constants.LeftFollower));

  // The motors on the right side of the drive.
  private final SpeedControllerGroup m_rightMotors =
      new SpeedControllerGroup(new PWMVictorSPX(Constants.RightLeader),
                               new PWMVictorSPX(Constants.RightFollower));
